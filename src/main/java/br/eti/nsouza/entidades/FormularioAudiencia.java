...
public class FormularioAudiencia implements Serializable {
	...
	public FormularioAudiencia(Integer idformulario, String nomeadvogado,
			String numoab, String telefoneadvogado, String advogadoadverso,
			String numoabadverso, String telefoneadvadervoso,
			String emailadvadverso, boolean defesagenerica,
			boolean contraproposta, boolean aijdesiginada, Date dataaij,
			double valorproposta, double valorcontraproposta,
			String obrigacaoafazer, String informecontraproposta,
			String objetodalide, String estrategiadefesa,
			String informeacontecimento, Integer nivel, Date dataformulario,
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((advogadoadverso == null) ? 0 : advogadoadverso.hashCode());
		...
		result = prime * result
				+ ((dataformulario == null) ? 0 : dataformulario.hashCode());
		result = prime * result + (defesagenerica ? 1231 : 1237);
		result = prime * result
				+ ((emailadvadverso == null) ? 0 : emailadvadverso.hashCode());
		result = prime
				* result
				+ ((estrategiadefesa == null) ? 0 : estrategiadefesa.hashCode());
		result = prime * result
				+ ((idformulario == null) ? 0 : idformulario.hashCode());
		result = prime
				* result
				+ ((informeacontecimento == null) ? 0 : informeacontecimento
						.hashCode());
		result = prime
				* result
				+ ((informecontraproposta == null) ? 0 : informecontraproposta
						.hashCode());
		result = prime * result + ((nivel == null) ? 0 : nivel.hashCode());
		result = prime * result
				+ ((nomeadvogado == null) ? 0 : nomeadvogado.hashCode());
		result = prime * result + ((numoab == null) ? 0 : numoab.hashCode());
		result = prime * result
				+ ((numoabadverso == null) ? 0 : numoabadverso.hashCode());
		result = prime * result
				+ ((objetodalide == null) ? 0 : objetodalide.hashCode());
		result = prime * result
				+ ((obrigacaoafazer == null) ? 0 : obrigacaoafazer.hashCode());
		result = prime
				* result
				+ ((telefoneadvadervoso == null) ? 0 : telefoneadvadervoso
						.hashCode());
		result = prime
				* result
				+ ((telefoneadvogado == null) ? 0 : telefoneadvogado.hashCode());
		long temp;
	...
	public boolean equals(Object obj) {
		...
		if (telefoneadvogado == null) {
			...
			return false;
		if (Double.doubleToLongBits(valoracordo) != Double
				.doubleToLongBits(other.valoracordo))
			return false;
		if (Double.doubleToLongBits(valorcontraproposta) != Double
				.doubleToLongBits(other.valorcontraproposta))
			return false;
		if (Double.doubleToLongBits(valorproposta) != Double
