...
public class Solicitacao implements Serializable {
	...
	//private boolean visuarq;

	public Solicitacao() {
		
	}

	public Solicitacao(Integer idsolicitacao, Integer referenciasolicitacao,
			Date datasolictacao, Date dataconclusao, Date dataprazo,
			String observacao, String instrucoes, String complemento,
			String justificativa, String tratposaudiencia, String numcontrole,
			boolean tempreposto, boolean convolada, String horaudiencia,
			String statusexterno, Processo processo, Renumeracao renumeracao,
			StatusSolicitacao statusSolicitacao, Comarca comarca,
			FormularioAudiencia formularioAudiencia,
			BancaProcesso bancaProcesso, Enviosolicitacao enviosolicitacao,
			ReciboPagamento reciboPagamento, Usuario usuario,
			AuditoriaInterna auditoriaInterna, float valor,
			float valordaalcada, String emailenvio, String pago, Integer grupo,
			boolean propostaacordo, boolean audinterna) {
		...
		//this.visuarq=visuarq;
	}

	//public boolean isVisuarq() {
	//	return visuarq;
	//}

	//public void setVisuarq(boolean visuarq) {
	//	this.visuarq = visuarq;
	//}
	...
	public int hashCode() {
		...
		result = prime * result + ((auditoriaInterna == null) ? 0 : auditoriaInterna.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (auditoriaInterna == null) {
			if (other.auditoriaInterna != null)
				return false;
		} else if (!auditoriaInterna.equals(other.auditoriaInterna))
			return false;
		if (complemento == null) {
	...
	public String toString() {
		return "Solicitacao [idsolicitacao=" + idsolicitacao
				+ ", referenciasolicitacao=" + referenciasolicitacao
				+ ", datasolictacao=" + datasolictacao + ", dataconclusao="
				+ dataconclusao + ", dataprazo=" + dataprazo + ", observacao="
				+ observacao + ", instrucoes=" + instrucoes + ", complemento="
				+ complemento + ", justificativa=" + justificativa
				+ ", tratposaudiencia=" + tratposaudiencia + ", numcontrole="
				+ numcontrole + ", tempreposto=" + tempreposto + ", convolada="
				+ convolada + ", horaudiencia=" + horaudiencia
				+ ", statusexterno=" + statusexterno + ", processo=" + processo
				+ ", renumeracao=" + renumeracao + ", statusSolicitacao="
				+ statusSolicitacao + ", comarca=" + comarca
				+ ", formularioAudiencia=" + formularioAudiencia
				+ ", bancaProcesso=" + bancaProcesso + ", enviosolicitacao="
				+ enviosolicitacao + ", reciboPagamento=" + reciboPagamento
				+ ", usuario=" + usuario + ", auditoriaInterna="
				+ auditoriaInterna + ", valor=" + valor + ", valordaalcada="
				+ valordaalcada + ", emailenvio=" + emailenvio + ", pago="
				+ pago + ", grupo=" + grupo + ", propostaacordo="
				+ propostaacordo + ", audinterna=" + audinterna + "]";
	}
