...
public class Processo implements Serializable {
	...
	public Processo(Integer idprocesso, String numeroprocesso, String parte,
			String adverso, String posicao, String status, String cartorio,
			String assunto, String localizacao, String numerointegracao,
			Comarca comarca, Orgao orgao, Integer numorgao,
			String proceletronico, Integer quantsoli) {
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((numerointegracao == null) ? 0 : numerointegracao.hashCode());
		result = prime * result
				+ ((numeroprocesso == null) ? 0 : numeroprocesso.hashCode());
		result = prime
				* result
				+ ((numeroprocessopesq == null) ? 0 : numeroprocessopesq
						.hashCode());
		result = prime * result
				+ ((numorgao == null) ? 0 : numorgao.hashCode());
		result = prime * result + ((parte == null) ? 0 : parte.hashCode());
		result = prime * result + ((posicao == null) ? 0 : posicao.hashCode());
		result = prime * result
				+ ((proceletronico == null) ? 0 : proceletronico.hashCode());
		result = prime * result
				+ ((quantsoli == null) ? 0 : quantsoli.hashCode());
